...
4. **Canonical truth sources are the MarketMind repo docs.** When in doubt, check README.md, ImplementationPlan.md, TechnicalRoadmap.md, WhitePaper.md, MetaLearningCore.md, and MetaLearningArchitectureVision.md for what is delivered vs. planned. Do not invent telemetry or performance evidence. Current canonical companion versions (see MarketMind README / VERSION): README **7.3.11** · Implementation Plan **v6.5.23** · Technical Roadmap **v1.4.33** · Meta-Learning Core **v1.2.25** · Meta-Learning Architecture Vision **v1.3.6** · Resolution Ledger **v1.0.67** · Threshold Governance Register **v1.0.6**.
...
6. **Phase II-0 vs Phase II distinction.** Phase II-0 is **non-promotable** research and contract wiring only (e.g. governed Phase II-0B artifact lane complete on that lane; Phase II-0C pilot harness complete as a research-only path — not promotable Phase II evidence). Phase II is promotable adaptive-learning machinery (conditional, not yet built). Do not describe Phase II-0 work as shipped Phase II machinery or as GATE-II / allocator readiness. The label "Phase II-0" may appear on the site with a clear explanation (e.g., "non-promotable harness" or "validation / contract wiring"). Do not imply that Phase II-0 activity means the meta-learning allocator is delivered or that promotion is imminent.
